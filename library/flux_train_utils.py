...
def get_noise(args, latents, noise, timesteps, train=True) -> torch.Tensor:
...
def get_noisy_model_input_and_timesteps(
    args, noise_scheduler, latents, noise, device, dtype, fixed_timesteps=None, train=True
...
def apply_model_prediction_type(args, model_pred, noisy_model_input, sigmas, train=True):
    weighting = None
    if args.model_prediction_type == "raw" or not train:
        pass
